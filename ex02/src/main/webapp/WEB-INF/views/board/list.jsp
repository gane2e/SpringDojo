		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<button id="regBtn" type="button" class="btn btn-xs pull-right"
					style="background-color: #dde3e9">Register new Board</button>
			</div>
			<!-- /.panel-heading -->
					...
					<ul class="pagination">
						...
						<c:if test="${pageMaker.first}">
							<li class="page-item paginate_button">
								<a class="page-link" href="${pageMaker.cri.pageNum=1}">1페이지</a>
							</li>
						</c:if>
						...
						<!-- 자바스크립트로 페이지넘버&bno처리 (form id: actionForm) -->
...
<script type="text/javascript">
	$(document).ready(
			function() {
				...
				// <a class='move' href='${board.bno}'>${board.title}</a> move 클릭 시 JS로직처리
